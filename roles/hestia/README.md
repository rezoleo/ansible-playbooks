...
- index.rezoleo.fr (port 3000)
- pdf.rezoleo.fr (port 3001)
- paperless.rezoleo.fr (port 3002)
...
Paperless est basé sur Paperless-NGX[^2]. Ce projet a d'abord été porté par Baptiste en 2024, qui a voulu faire un postgres managé. Le postgres managé a été fait (Babar).
